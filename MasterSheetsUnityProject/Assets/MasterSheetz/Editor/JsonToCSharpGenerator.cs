...
namespace App.MasterData.AutoGenerated
{
    internal static class JsonToCSharpGenerator
    {
        ...
        {
            var asset = MasterDataConfigAssetCreator.GetAsset<MasterSheetzConfigAsset>();
            if (asset == null)
            {
            ...
            string nameSpace)
        {
            ...
            classDef.AppendLine(
                $"    public partial class {masterDataTableClassName} : MasterDataTable<{masterDataClassName}>"
            );
            classDef.AppendLine("    {");
            classDef.AppendLine(
